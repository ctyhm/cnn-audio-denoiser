...
class lntu:
    ...
    def _get_urban_sound_8K_filenames(self):
        urbansound_metadata = pd.read_csv(os.path.join(self.basepath, 'metadata', 'lntu.csv'))
    ...
    def _get_filenames_by_class_id(self, metadata):
        ...
        for c in self.class_ids:
            ...
            per_class_files = [os.path.join(self.basepath, 'audio', str(file[1]), file[0]) for file in
                               per_class_files]
